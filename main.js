const $ = document;
const para = $.querySelector("p");
const image = $.querySelector("img");
const strong = $.querySelector("strong");
...
para.innerHTML = firstTestimonial.text
image.src = firstTestimonial.photo
strong.innerHTML = firstTestimonial.name
small.innerHTML = firstTestimonial.position
